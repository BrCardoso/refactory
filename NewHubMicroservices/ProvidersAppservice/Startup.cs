...
using ProvidersAppservice.Business;
using ProvidersAppservice.Business.Interface;
using ProvidersAppservice.Repository;
using ProvidersAppservice.Repository.Interface;

namespace ProvidersAppservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Businesses
            services.AddScoped<IPriceTableBusiness, PriceTableBusiness>();
            services.AddScoped<IProviderStrucBusiness, ProviderStrucBusiness>();

            //Repositories
            services.AddScoped<IPriceTableRepository, PriceTableRepository>();
            services.AddScoped<IProviderRepository, ProviderRepository>();
            services.AddScoped<IProviderStrucRepository, ProviderStrucRepository>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                {
                    await context.Response.WriteAsync($"Hello World! This a provider API.");
                });
