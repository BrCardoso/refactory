...
{
    public class MandatoryRulesBlockPlanService : IMandatoryRulesService
    {
        ...
        private readonly MovimentTypeEnum movimentType = MovimentTypeEnum.BLOQUEIO;
        public MandatoryRulesBlockPlanService(IMandatoryRulesRequestService mandatory, ITaskPanelRequestService task, IEmployeeRequestService employeeRequestService, IMandatoryRulesRuleValidationService mandatoryRulesRuleValidationService)
        {
