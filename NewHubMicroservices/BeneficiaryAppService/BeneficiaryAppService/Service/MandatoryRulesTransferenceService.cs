...
{
    public class MandatoryRulesTransferenceService : IMandatoryRulesService
    {
        ...
        private readonly MovimentTypeEnum movimentType = MovimentTypeEnum.TRANSFERENCIA_DE_PLANO;
        public MandatoryRulesTransferenceService(IMandatoryRulesRequestService mandatory, ITaskPanelRequestService task, IEmployeeRequestService employeeRequestService, IMandatoryRulesRuleValidationService mandatoryRulesRuleValidationService)
        {
