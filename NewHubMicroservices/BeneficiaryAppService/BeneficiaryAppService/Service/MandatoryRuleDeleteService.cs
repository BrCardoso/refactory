...
{
    public class MandatoryRulesDeleteService : IMandatoryRulesService
    {
        ...
        private readonly MovimentTypeEnum movimentType = MovimentTypeEnum.EXCLUSÃO;
        public MandatoryRulesDeleteService(IMandatoryRulesRequestService mandatory, ITaskPanelRequestService task, IEmployeeRequestService employeeRequestService, IMandatoryRulesRuleValidationService mandatoryRulesRuleValidationService)
        {
